...
public class HallmeterViewer extends View {
	...
	public HallmeterViewer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public HallmeterViewer(Context context, AttributeSet attrs, int defStyle) {
